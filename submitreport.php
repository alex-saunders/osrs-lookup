...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <script src="/js_assets/allitems.js"></script>
   </head>
   <body>
   		<center>
   	  <div id="cookie_bar">
               ...
               <td>
                  ...
                  <center>
                        ...
                        <tr>
                           <td height="20%">
                              <div class="title_container" style="margin-left:2%;">
                                 ...
                                 <span style="margin-right:15px;">Item </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Correction
                                 </span>
                              </div>
                           </td>
						 </tr>
						 ...
						 <br/>You are submitting a correction for an item in our current database, this may be that it's stats are wrong, it's icon is misrepresentative or anything else concerning the item's info that is currently displayed.<br/><br/>
						 <center><span class="alert_div">Any content submitted that is not a correction will be disregarded.</span></center>
						 </div>
						 <br/>
						 </td>
						 </tr>
                     ...
                     <tr>
                        ...
                        <tr>
                        <td>
                        <input type='text' class='txtInput' value='' style='width:97%; height:30px' onkeyup='showHint(this.value, event, 0)' 
                        onkeydown='navigateTest(event)' placeholder='empty' autocomplete='off'>
                        </td>
                        </tr>
                        <tr>
                        <td class='txtHint'>
                        ...
                        <td colspan="2">
                        <b>
                        *Your correction submission: (max 500 characters)
                        </b>
                        </td>
                        </tr>
                        <tr class="item_table_light">
                        ...
                        placeholder="Please describe what you believe to be wrong about the chosen item here"></textarea>
                        </td>
                        </tr>
                        <tr class="item_table_dark">
                        <td colspan="2">
                        ...
                        <button class="button" onclick="submitForm()" id="feedback_button">I agree - submit my correction</button>
                        </center>
                        </td>
                        </tr>
                        </table>
